...
새 저장소에 이슈·PR 양식과 라벨을 적용할 때 읽습니다. 일상 작업은 [GitHub 작업 가이드](../conventions/github-workflow.md)에서 선택합니다.
...
새 모듈 이름마다 라벨을 미리 늘리지 않습니다. 실제 분류에 필요할 때 정의 파일·양식·[라벨 운영](../conventions/github-publishing.md#라벨-운영)를 함께 갱신하고 대상 저장소에 다시 적용합니다.
