...
조사 결론은 이슈에 남기고, 확정된 구조·정책은 관련 컨벤션과 해당 주제 ADR에 반영합니다. 독립적인 새 주제의 기록은 [ADR 관리 규칙](../agents/documents/maintenance.md#maintenance)을 따르며, [현재 ADR 요약](../adr/README.md)을 함께 맞춥니다. 코드·상시 문서 변경이 없으면 PR 없이 이슈에서 마무리합니다.
