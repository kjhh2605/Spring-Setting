...
작업에 해당하는 행부터 읽고, 변경하는 책임에 필요한 문서만 추가합니다. 각 주제의 상세 규칙은 아래 문서가 소유하며, AI 작업 방식과 완료 명령은 [루트 지침](../../AGENTS.md)이 원본입니다. 루트·하위 지침의 핵심 제약은 요약으로 유지하고, 상세 규칙을 바꿀 때 해당 요약도 맞춥니다.
...
| 커밋·브랜치·승인·이슈·라벨·PR과 AI 리뷰 | [GitHub 작업 가이드](github-workflow.md) | 자동 커밋 단위·검증·승인 요약, 유형·양식 선택; 필드·라벨 값은 연결된 양식·정의 파일 |
...
| 제품 유즈케이스·정책 검토 | [기획 초안](../planning/use-cases.md) | 제안된 업무·모듈과 구현 전 미결정 사항 |
